...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{2DBB2570-2821-7CCA-51D5-55AD0DC76A2C}</ProjectGuid>
  ...
  <ItemGroup>
    <ClCompile Include="C:\Users\user\AppData\Local\node\corepack\v1\pnpm\8.15.0\dist\node_modules\node-gyp\src\win_delay_load_hook.cc"/>
  </ItemGroup>
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\pulsar.node">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;C:\Users\user\PULSCO\node_modules\.pnpm\pulsar-client@1.16.0\node_modules\pulsar-client\lib\binding&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)pulsar.node&quot; &quot;C:\Users\user\PULSCO\node_modules\.pnpm\pulsar-client@1.16.0\node_modules\pulsar-client\lib\binding\pulsar.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/pulsar.node to C:\Users\user\PULSCO\node_modules\.pnpm\pulsar-client@1.16.0\node_modules\pulsar-client\lib\binding</Message>
      <Outputs>C:\Users\user\PULSCO\node_modules\.pnpm\pulsar-client@1.16.0\node_modules\pulsar-client\lib\binding\pulsar.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="pulsar.vcxproj">
      <Project>{E7C0362E-9F45-4217-C2AA-DE8D35C51910}</Project>
